...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1>About us</h1>
            <p>Building the future of small business management, one feature at a time.</p>
        </div>
    </section>
                ...
                <div class="mission-content">
                    ...
                    <div class="mission-points">
                        <div class="mission-point">
                            ...
                            <p>Better than spreadsheets, simpler than enterprise-level software</p>
                        </div>
                        <div class="mission-point">
                            <svg class="check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mission-point">
                            ...
                            <p>One-time payment - no subscriptions or hidden fees</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="product-overview">
        <div class="container">
            ...
            <p>Argo Sales Tracker is a free, easy-to-use, yet powerful Windows app built for small
                ...
                version is completely free to use, and you can upgrade anytime for advanced features like unlimited
                products and premium features. Unlike bloated overpriced enterprise tools or clunky spreadsheets, Argo
                strikes the perfect balance between ease of use and powerful functionality—no subscriptions required.
            </p>
        </div>
    </section>
