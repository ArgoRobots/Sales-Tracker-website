        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchBox.addEventListener('input', function() {
                ...
                categories.forEach(category => {
                    const countryGroups = category.querySelectorAll('.item-group, .alphabet-section');
                    const countryItems = category.querySelectorAll('.items-list li');
                    ...
                    countryItems.forEach(item => {
                        ...
                        if (isMatch) {
                            ...
                            const parentGroup = item.closest('.item-group, .alphabet-section');
                            if (parentGroup) {
                    ...
                    countryGroups.forEach(group => {
                        const visibleItems = group.querySelectorAll('.items-list li:not([style*="display: none"])');
                    ...
                    if (searchTerm !== '') {
                        const visibleGroups = category.querySelectorAll('.item-group:not([style*="display: none"]), .alphabet-section:not([style*="display: none"])');
