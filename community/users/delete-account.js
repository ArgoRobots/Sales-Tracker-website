document.addEventListener("DOMContentLoaded", function () {
  ...
  function showPageSuccessMessage(message) {
    ...
    // Insert near the delete account section instead
    const deleteSection = document.querySelector(".delete-account-section");
    if (deleteSection) {
      deleteSection.insertAdjacentElement("beforebegin", successDiv);
    } else {
      // Fallback to top
      const editSections = document.querySelector(".edit-sections");
      editSections.insertBefore(successDiv, editSections.firstChild);
    }
